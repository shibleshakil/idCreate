...
<body class="bg-shade_deep">
      ...
      <div class="flex flex-row justify-center space-x-2 lg:space-x-5 items-center text-center">
        <div class="dropdown lg:inline-block ">
          <button class="text-primary font-semibold text-xl lg:text-2xl inline-flex">
            <span class="mr-1">ভাষা</span>
            <svg class="fill-current h-4 w-4 mt-2 lg:mt-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
  ...
  <section class="bg-shade py-10 md:py-24 px-5 mx-auto ">
    <div class="flex flex-col items-start mx-auto w-full md:w-1/2 lg:w-1/3 text-text font-bangla">
      <div class="text-xl md:text-2xl lg:text-3xl font-semibold">Welcome</div>
      <div class="text-lg md:text-xl lg:text-2xl text-justify w-full inline-block">
        in garments & accessories digital service "GAAC".
        Explore our digital services below link and join with us.
        If you face any problem, please send message us.</div>

      <div class="flex flex-row justify-between items-center text-lg md:text-xl lg:text-2xl text-white w-full pt-5">
        <a href="./homepage/digital_service.html"
          class="bg-primary rounded-md text-center items-center px-2 lg:px-4 py-1 hover:text-shade_deep">Digital service
        </a>
        <a href="./message/guest_message.html"><img class="w-10 " src="./nav_icon/msg5.png" alt="message"></a>
      </div>
    </div>
  </section>
  ...
  <section class="bg-shade_deep py-10 md:py-24 px-5 mx-auto">
    <div
      ...
      <div>Create id as per your category</div>
      <div class="pt-10 flex flex-col mx-auto items-center w-full text-sm md:text-xl lg:text-2xl mt-8 ">
        ...
        <div id="owner" class="hidden w-full mx-auto items-center">
          <div class="flex flex-row space-x-2 lg:space-x-8 py-4 w-full items-center mx-auto justify-center mt-8">
            <a href="./form/owner_form.html"
              class="bg-primary text-white rounded-full w-1/3 lg:w-44 py-2 text-center hover:text-shade_deep text-sm md:text-xl lg:text-2xl">Owner</a>
            <a href="./form/staff_form.html"
              class="bg-primary text-white rounded-full w-1/3 lg:w-44 py-2 text-center hover:text-shade_deep text-sm md:text-xl lg:text-2xl">Staff</a>
            <a href="./form/worker_form.html"
              class="bg-primary text-white rounded-full w-1/3 lg:w-44 py-2 text-center hover:text-shade_deep text-sm md:text-xl lg:text-2xl">Worker</a>
          </div>
        </div>
        <a href="./buyer/form/buyer_form.html"
