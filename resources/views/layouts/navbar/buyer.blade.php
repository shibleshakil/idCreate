<nav class="md:mx-auto flex flex-row text-base justify-between w-full lg:w-[40%]">
    ...
    <a class=" w-full flex justify-center text-primary text-center px-3 md:px-10 lg:px-10 py-3 lg:py-5 hover:bg-shade text-2xl lg:text-3xl "
        href="/homepage/buyer_mission.html">
        <img class=" w-6 lg:w-12" src="{{ asset ('/nav_icon/mission.png') }}" alt="mission">
    </a>
    <a class=" w-full flex justify-center text-primary text-center px-3 md:px-10 lg:px-10 py-3 lg:py-5 hover:bg-shade text-2xl lg:text-3xl "
        href="/message/buyer_message.html">
        <img class=" w-6 lg:w-12" src="{{ asset ('/nav_icon/message.svg') }}" alt="message">
    </a>
    <a class=" w-full flex justify-center text-primary text-center px-3 md:px-10 lg:px-10 py-3 lg:py-5 hover:bg-shade text-2xl lg:text-3xl "
        href="/news/buyer_news.html">
        <img class=" w-6 lg:w-12" src="{{ asset ('/nav_icon/news.svg') }}" alt="news">
    </a>
    <a class=" w-full flex justify-center text-primary text-center px-3 md:px-10 lg:px-10 py-3 lg:py-5 hover:bg-shade text-2xl lg:text-3xl @if($url == 'buyerSettings') border-b-4 border-b-primary @endif"
        href="{{ route ('buyerSettings') }}">
