<nav class="md:mx-auto flex flex-row text-base justify-between w-full lg:w-[40%]">
    ...
    <a class=" w-full flex justify-center text-primary text-center px-3 md:px-10 lg:px-10 py-3 lg:py-5 hover:bg-shade text-2xl lg:text-3xl @if($url == 'ownerSettings' || $url == 'changePasswordForm' || $url == 'changeIDForm') border-b-4 border-b-primary @endif"
        href="{{ route ('ownerSettings') }}">
