...
<div class="py-8 mx-auto text-center items-center lg:text-xl">
    <div class="w-full font-bangla mx-auto"> ইউজার সেটিংস সম্বন্ধে <a href="#" class="text-primary hover:underline">
            বিস্তারিত জানুন </a> </div>
</div>
...
<!-- hero -->
<div class="pt-2 pb-6">
    <div class="w-36 h-36 bg-white rounded mx-auto mt-8"></div>
</div>
...
<div class="pb-6">
    <div class="lg:w-1/3 w-full text-center mx-auto text-text font-bangla  text-lg lg:text-xl">পদবী</div>
</div>
